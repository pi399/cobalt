...
function World:playMusic() TEsound.playLooping(self.music,self.name) end
function World:pauseMusic() TEsound.pause(self.name) end
function World:resumeMusic() TEsound.resume(self.name) end
